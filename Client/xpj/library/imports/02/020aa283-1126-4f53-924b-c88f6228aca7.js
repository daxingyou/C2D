"use strict";
cc._RF.push(module, '020aaKDESZPU5JLyI9iKKyn', 'UIManager');
...
var UIManager = /** @class */ (function () {
    function UIManager() {
        ...
        this.cb_before_scene_loading = function (event) {
            ...
            var seneceName = cc.director.getScene().name;
            if (seneceName === 'ZJHScene' || seneceName === 'NNScene') {
                ModuleManager_1.mp_manager.playBackGround();
            }
        };
        /**
         * 场景切换后的回调
        ...
        this.cb_after_scene_loading = function (event) {
            var seneceName = cc.director.getScene().name;
            if (seneceName === 'ZJHScene' || seneceName === 'NNScene') {
                ModuleManager_1.mp_manager.stopBackGround();
            }
        };
        /**
         * 游戏每帧刷新前的回调
     ...
     * @memberof UIManager
     */
    UIManager.prototype.setLoading = function (msg) {
        if (this.isShowLoading) {
            var loading = this.getCanvasNode().getChildByName('Loading').getComponent('Loading');
            loading.setMsg(msg);
        }
    };
    /**
