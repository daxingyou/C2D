...
export default class Room_Create extends cc.Component {
    ...
    */
    ...
    create_game_item(data: RuleCfgVo): void {
        ...
        let toggle_addLable = room_item_game.getComponent('Toggle_AddLabel');
    ...
    create_rule_item(data: RuleContent): void {
        ...
        for (var i = 0; i < data.ruleContentItems.length; i++) {
            let room_tg = this.create_item_toggleGroup(cf_layout);
            let ruleContentItem = data.ruleContentItems[i];
     ...
     * @memberof Room_Create
     */
    create_item_toggleGroup(parentNode: cc.Node): cc.Node {
