...
cc._RF.push(module, '5ac27gyp1lB9aG2YecI9JJS', 'NativeCallJS', __filename);
 ...
 */
function voiceLoginCallback(result) {
    cc.systemEvent.emit('cb_voiceLogin', result);
}
exports.voiceLoginCallback = voiceLoginCallback;
/**
 * 退出房间回调
 *
 * @export
